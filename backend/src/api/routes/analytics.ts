...
analyticsRouter.get('/questions', async (req: Request, res: Response) => {
  try {
...
analyticsRouter.get('/popular-questions', async (req: Request, res: Response) => {
  try {
...
analyticsRouter.get('/policy-coverage', async (req: Request, res: Response) => {
  try {
    const result = await query(
      `SELECT 
        p.id,
